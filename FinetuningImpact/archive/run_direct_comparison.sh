...
# Direct SAE Feature Comparison Script
# Compares SAE features directly without running separate AutoInterp analyses

echo "🚀 Direct SAE Feature Comparison"
echo "================================"
...
# Set paths
BASE_SAE="/home/nvidia/Documents/Hariom/saetrain/trained_models/llama2_7b_hf_layers4_10_16_22_28_k32_latents400_wikitext103_torchrun"
FINETUNED_SAE="/home/nvidia/Documents/Hariom/saetrain/trained_models/llama2_7b_finance_layers4_10_16_22_28_k32_latents400_wikitext103_torchrun"
...
echo "🚀 Running direct SAE feature comparison..."
echo ""

python direct_sae_comparison.py \
    --base_sae "$BASE_SAE" \
...
echo ""
echo "✅ Direct SAE comparison complete!"
echo "📊 Results saved to: sae_comparison_results.json"
echo ""
