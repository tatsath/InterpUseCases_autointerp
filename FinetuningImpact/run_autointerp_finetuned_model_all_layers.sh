...
# AutoInterp Analysis for Finetuned Model (cxllin/Llama2-7b-Finance) - All Layers
# Optimized parameters for better F1 scores and proper financial specialization

set -e

echo "🔍 Running OPTIMIZED AutoInterp analysis for FINETUNED model - ALL LAYERS"
...
# Output directory
OUTPUT_DIR="autointerp_finetuned_model_all_layers_results"
mkdir -p "$OUTPUT_DIR"
...
for layer in "${LAYERS[@]}"; do
    ...
    RUN_NAME="finetuned_model_layer${layer}_all_layers"
...
echo "✅ All layers completed for FINETUNED model"
